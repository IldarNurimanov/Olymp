...
object DataBase {
    ...
    private fun getCollection() = db.collection("Classrooms")
    ...
    suspend fun getEventFromServer(numberClassroomView: String) {
        if (numberClassroomView.isEmpty()) {
