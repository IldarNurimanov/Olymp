...
// was not changed.  Do this using the timestamp since we can't compare PointCloud objects.
    ...
    override fun onDrawFrame(render: SampleRender?) {
            ...
            try {
                ...
                image?.let { imageInput ->
                    try {
                        ...
                        println("InputImage = ${inputImage ?: "null"}")
                        ...
                        Timber.d("Failed to load the image")
                        e.printStackTrace()
                    }
                }
        ...
        visiontext?.let {
            ...
            DataBase.currentEvent.value?.let {
                noTap(frame, camera, visiontext!!, it)
            }
        }
    ...
    private fun noTap(
        ...
        val numberClassroom: String = event.numberClassRoom ?: return
